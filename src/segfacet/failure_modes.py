...
_MODE_3 = ModeSpec(
    ...
    mechanism=(
        ...
        "committed corpora (2026-09-23, item 173's lordotic base): the only "
        "firing value is 775.0 mm^2 "
        "(label 23 against label 22 on the split case, +675.0 above "
    ...
    corpus_cases=(
        CorpusCaseExpectation(
            ...
            reason=(
                ...
                "item 167): stray_contact_area_mm2=775.0 against label 22 "
                "(measured 2026-09-23 on item 173's lordotic base), +675.0 "
                "above the 100.0 mm^2 threshold. Both findings "
