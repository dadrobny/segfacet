...
- **A2: roadmap v3.1's Stage 30 annotation is the authority on how the immutable
  ...
  proceed without.
- **A3 (engine 1.37.0):** `aide progress accept <stage> --criterion N --evidence
  ...
  on this.
- **A4 (engine 1.37.0):** `aide progress amend` appends
...
- **A5 (engine 1.37.0):** `aide check` at this branch's base reports
