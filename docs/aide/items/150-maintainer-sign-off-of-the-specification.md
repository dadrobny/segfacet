...
- **A1 (engine 1.37.0, re-checked 1.52.1):** `aide gate approve|decline <n> --evidence "…"` writes
...
- **A2 (engine 1.37.0, re-checked 1.52.1):** a `## Human gates` row is four cells
...
- **A3 (engine 1.37.0, re-checked 1.52.1):** `run_checks` emits the human-gate warning
