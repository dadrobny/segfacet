...
- **A1 (engine 1.37.0, re-checked 1.52.1, re-checked 1.59.0, re-checked 2.1.0): `derive_status` must derive `implemented` on "a
  ...
  diff.
- **A2 (engine 1.37.0, re-checked 1.52.1, re-checked 1.59.0, re-checked 2.1.0): item 144's committed AC9 test must be reconciled with
  A1, in the same edit.**
